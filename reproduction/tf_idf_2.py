...
dataset = '/home/mdafifal.mamun/notebooks/triagerX/data/mozilla_firefox/classifier_data_20.csv'
...
print(len(df_train["owner"].value_counts()))
...
classifier = SVC(probability=True, verbose=True)  # Set probability=True to enable probability estimates

# Train the classifier
classifier.fit(X_train_tfidf, y_train)

# print("Load model")
# with open("/home/mdafifal.mamun/notebooks/triagerX/model_ts_20.pkl", 'rb') as file:
